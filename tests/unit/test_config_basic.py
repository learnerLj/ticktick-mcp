...
class TestTickTickConfig:
    ...
    def test_config_creation(self):
        ...
        config = TickTickConfig(client_id="test_id", client_secret="test_secret")
    ...
    def test_config_dida365_mode(self):
        ...
        config = TickTickConfig(
            client_id="test_id", client_secret="test_secret", use_dida365=True
        )
    ...
    def test_config_missing_client_id(self):
        ...
        with pytest.raises(ConfigurationError, match="TICKTICK_CLIENT_ID is required"):
            TickTickConfig(client_id="", client_secret="test_secret")

    def test_config_missing_client_secret(self):
        """Test configuration validation with missing client_secret."""
        with pytest.raises(
            ConfigurationError, match="TICKTICK_CLIENT_SECRET is required"
        ):
            TickTickConfig(client_id="test_id", client_secret="")
